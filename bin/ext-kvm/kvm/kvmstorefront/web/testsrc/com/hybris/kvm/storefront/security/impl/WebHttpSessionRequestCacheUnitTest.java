...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/kvmstorefront/electronics/en",
						"https://electronics.local:9002/kvmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/kvmstorefront/electronics/en",
						"https://electronics.local:9002/kvmstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/kvmstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/kvmstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/kvmstorefront/electronics/en",
						"https://electronics.local:9002/kvmstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/kvmstorefront",
						"https://electronics.local:9002/kvmstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/kvmstorefront",
						"https://electronics.local:9002/kvmstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/kvmstorefront/electronics/en",
						"https://electronics.local:9002/kvmstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
