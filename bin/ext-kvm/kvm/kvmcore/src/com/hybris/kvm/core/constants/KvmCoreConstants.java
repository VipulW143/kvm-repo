 ...
 */
package com.hybris.kvm.core.constants;

/**
 * Global class for all KvmCore constants. You can add global constants for your extension into this class.
 */
public final class KvmCoreConstants extends GeneratedKvmCoreConstants
{
	public static final String EXTENSIONNAME = "kvmcore";


	private KvmCoreConstants()
	{
		//empty
	}
