 ...
 */
package com.hybris.kvm.cockpits.setup;
...
import com.hybris.kvm.cockpits.constants.KvmCockpitsConstants;
 ...
 */
@SystemSetup(extension = KvmCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(KvmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(KvmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						KvmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/kvmcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
