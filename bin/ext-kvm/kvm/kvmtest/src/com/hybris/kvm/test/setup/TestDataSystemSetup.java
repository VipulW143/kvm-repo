 ...
 */
package com.hybris.kvm.test.setup;
...
import com.hybris.kvm.test.constants.KvmTestConstants;
import com.hybris.kvm.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = KvmTestConstants.EXTENSIONNAME)
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			else
			{
				...
				importImpexFile(context, "/kvmtest/import/qa-test-users.impex");

				LOG.info("Creating Reviews...");
				importImpexFile(context, "/kvmtest/import/reviews.impex");
				...
				importImpexFile(context, "/kvmtest/import/cstickets.impex");

				LOG.info("Creating Test Quotes...");
				importImpexFile(context, "/kvmtest/import/csquotes.impex");
			}
		}
	}
}
