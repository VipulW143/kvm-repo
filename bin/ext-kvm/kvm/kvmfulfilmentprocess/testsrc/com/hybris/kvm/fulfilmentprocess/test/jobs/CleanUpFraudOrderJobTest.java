 ...
 */
package com.hybris.kvm.fulfilmentprocess.test.jobs;
...
import com.hybris.kvm.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = KvmFulfilmentProcessConstants.ORDER_PROCESS_NAME;
