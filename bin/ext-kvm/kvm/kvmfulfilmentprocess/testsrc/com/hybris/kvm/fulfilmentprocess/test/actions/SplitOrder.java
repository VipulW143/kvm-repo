 ...
 */
package com.hybris.kvm.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(KvmFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(KvmFulfilmentProcessConstants.PARENT_PROCESS);
